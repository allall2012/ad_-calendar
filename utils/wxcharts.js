...
function drawRingTitle(opts, config, context) {
    ...
    // var titleFontColor = opts.foreColor;
    context.setFillStyle(opts.foreColor);
    // context.fillText(title, _startX, _startY);
    var textTop = opts.textTop;
    var textLeft = opts.textLeft; 
    context.setTextBaseline('middle')
    context.setTextAlign('center')
    context.fillText(title, textTop, textLeft)
    return;
